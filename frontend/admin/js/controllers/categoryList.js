app.controller('CategoryListCtrl', function ($scope, $http, $window) {
    $scope.categories = [];    // Start off with empty clients array
    $scope.pages = [];
    ...
    $scope.handleAction = function(action, id) {
        switch(action) {
            ...
            case "edit":
                $window.location.href = "#!/categories/detail/" + id;
                break;
